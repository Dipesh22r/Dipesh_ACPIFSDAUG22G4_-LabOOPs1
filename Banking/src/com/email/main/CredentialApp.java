...
public class CredentialApp {
	...
	public static void main(String[] args) {
		...
		Employee employee=new Employee("Dipesh","rawat");
		...
		if(option==1) {
			 ...
			 generatedEmail=credentialService.generateEmailAddress(employee.getFirstName(),employee.getLastName(),"leg");
		...
		credentialService.showCredentilas(employee.getFirstName(),generatedEmail,generatedPwd); 
